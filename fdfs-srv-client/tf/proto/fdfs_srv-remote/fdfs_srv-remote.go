...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  UploadResp upload(UploadReq req)")
  fmt.Fprintln(os.Stderr, "  DownloadResp download(DownloadReq req)")
  fmt.Fprintln(os.Stderr, "  DeleteResp deleteFile(DeleteReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := proto.NewFdfsSrvClientFactory(trans, protocolFactory)
  ...
  case "upload":
    ...
    value0 := argvalue0
    fmt.Print(client.Upload(value0))
    fmt.Print("\n")
    break
  case "download":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := proto.NewDownloadReq()
