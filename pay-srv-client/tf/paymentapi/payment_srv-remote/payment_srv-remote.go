...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  GetPayInfoResp GetPayInfo(GetPayInfoReq req)")
  fmt.Fprintln(os.Stderr, "  OrderQueryResp OrderQuery(OrderQueryReq req)")
  fmt.Fprintln(os.Stderr, "  CloseOrderResp CloseOrder(CloseOrderReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := paymentapi.NewPaymentSrvClientFactory(trans, protocolFactory)
  ...
  case "GetPayInfo":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetPayInfo requires 1 args")
      flag.Usage()
    }
    arg8 := flag.Arg(1)
    ...
    argvalue0 := req.NewGetPayInfoReq()
    ...
    value0 := argvalue0
    fmt.Print(client.GetPayInfo(value0))
    fmt.Print("\n")
    break
  case "OrderQuery":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "OrderQuery requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    argvalue0 := req.NewOrderQueryReq()
    ...
    value0 := argvalue0
    fmt.Print(client.OrderQuery(value0))
    fmt.Print("\n")
    break
  case "CloseOrder":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "CloseOrder requires 1 args")
      flag.Usage()
    }
    arg20 := flag.Arg(1)
    ...
    argvalue0 := req.NewCloseOrderReq()
    ...
    value0 := argvalue0
    fmt.Print(client.CloseOrder(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
